...
(defn- aoc-get-exercise-html [day]
...
(defn read-input [day]
  (let [file (str "static/" day "/input.txt")]
    (trim (slurp file))))

(defn lines [input] (split input #"\n"))

(defmacro defnm [name params & body]
